...
thermostatApp.intent('setTemp', function(req, res) {
  request.post(process.env.192.168.1.151 + '/tstat', {json: {t_cool: parseFloat(req.slot('setTemperature'))}});
...
thermostatApp.intent('getTemp', function(req, res) {
  request(process.env.192.168.1.151 + '/tstat', function (error, response, body) {
